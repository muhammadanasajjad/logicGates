...
function setup() {
  ...
  for (let i = 0; i < 4; i++) {
    subGates.push(new Gate(0, i * 40, "INPUT"));
  }

  // console.log(chips["NAND"]);
  // console.log(chips);
  // subGates.push(getChipCopy(chips["NAND"]));
  // subGates.push(new Gate(100, 40, "OR"));

  // subWires.push(new Wire(0, 0, 5, 0, [], 1));
  // subWires.push(new Wire(1, 0, 5, 1, [], 1));
  // subWires.push(new Wire(0, 0, 4, 0, [], 1));
  // subWires.push(new Wire(3, 0, 4, 1, [], 1));

  for (let i = 0; i < 2; i++) {
    subGates.push(new Gate(200, i * 40, "OUTPUT"));
  }
  // subWires.push(new Wire(4, 0, 5, 0, [], 1));
  // // subWires.push(new Wire(5, 0, 7, 0, [], 1));

  // gates.push(new Gate(100, 100, "computedChip", "", subGates, subWires));
  ...
  // subGates.push(new Gate(100, 40, "AND"));

  // for (let i = 0; i < 1; i++) {
  //     subGates.push(new Gate(200, i * 40, "OUTPUT"));
  // }
  // subWires.push(new Wire(0, 0, 3, 0, [], 1));
  // subWires.push(new Wire(2, 0, 3, 1, [], 1));

  // subWires.push(new Wire(3, 0, 4, 0, [], 1));

  // gates.push(new Gate(100, 100, "computedChip", "", subGates, subWires));

  // for (let i = 0; i < 4; i++) {
  //     gates.push(new Gate(0, i * 40, "INPUT"));
  // }

  // gates.push(getChipCopy(chips["NAND"]));
  // gates.push(new Gate(100, 40, "OR"));

  // for (let i = 0; i < 2; i++) {
  //     gates.push(new Gate(200, i * 40, "OUTPUT"));
  // }
  // wires.push(new Wire(0, 0, 5, 0, [], 1));
  // wires.push(new Wire(1, 0, 5, 1, [], 1));
  // wires.push(new Wire(2, 0, 4, 0, [], 1));
  // wires.push(new Wire(3, 0, 4, 1, [], 1));
  // wires.push(new Wire(4, 0, 6, 0, [], 1));
  // wires.push(new Wire(5, 0, 7, 0, [], 1));
...
function draw() {
  ...
  if (selectedWire) {
    ...
    wire.show(gates);
    // gates[gates.length - 1].show(onColour, offColour);
